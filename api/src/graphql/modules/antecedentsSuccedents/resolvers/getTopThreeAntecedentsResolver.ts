import {
  ...
  QueryGetTopThreeAntecedentsArgs,
} from "../../../../types/graphqlTypesGenerated";
import { CustomContext } from "../../../../types/types";

export const getTopThreeAntecedentsResolver = async (
  _: unknown,
  { eventTypeId }: QueryGetTopThreeAntecedentsArgs,
  ...
  const AntecedentSuccedents = await dbConnection.query<AntecedentSuccedent>(
    "SELECT related_type_id, COUNT(*) AS antecedent_count " +
      "FROM antecedents_succedents WHERE event_type_id = $1 AND relationship = 1 " +
